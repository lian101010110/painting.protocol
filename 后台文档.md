...
## 50用户封号（/admin/user/updateLock.do\"）
...
## 51用户地址列表（/admin/user/address/list.do\"）
...
## 52用户评价列表（/admin/commodity/evaluate/list.do\"）
...
## 53修改评价排序（/admin/commodity/evaluate/updateSort.do）
