...
## 42 购物车修改（/user/cart/updateSel.do）
...
## 43 商品列表随机推荐（/ commodity/ranklist.do）
...
## 44 添加浏览记录（/user/browser/history/add.do）
...
## 45浏览记录删除（/user/browser/history/del.do）
...
## 46浏览记录列表（/user/browser/history/list.do）
...
## 47商品详情页面评价查看（/commodity/evaluate/list.do）
...
## 48评价添加（/user/commodity/order/evaluate/add.do）
...
## 49评价更新（/user/commodity/order/evaluate/update.do）
...
## 50评价删除（/user/commodity/order/evaluate/del.do）
...
## 51列表（/user/commodity/order/evaluate/list.do）
...
## 52列表附带商品信息（/user/commodity/order/evaluate/listWithCommodity.do）
